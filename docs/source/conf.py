...
# cgm_analysis_project documentation build
...
from cgm_analysis_project import __version__ as release

# -- Project information -----------------------------------------------------

project = "cgm_analysis_project"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "cgm_analysis_projectdoc"
...
latex_documents = [
    (
        master_doc,
        "cgm_analysis_project.tex",
        "cgm_analysis_project Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "cgm_analysis_project",
        "Project cgm_analysis_project codebase.",
        "Data-Science",
    )
]
